...
int main() {
	...
	while(test_cases--) {
		...
		printf("Time taken by Bubble Sort algorithm for random input of size %d is %d \n", n, time_taken);
		
		increasing_input_generator(arr, n);
		time_taken = time_calculator(arr, n);
		printf("Time taken by Bubble Sort algorithm for increasing input of size %d is %d \n", n, time_taken);
		
		decreasing_input_generator(arr, n);
		time_taken = time_calculator(arr, n);
		printf("Time taken by Bubble Sort algorithm for decreasing input of size %d is %d \n\n", n, time_taken);
